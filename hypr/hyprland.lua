...
local colors = dofile(os.getenv("HOME") .. "/.config/hypr/colors/colors.lua")


local function c(hex)
    local stripped = hex:gsub("0xff", "")
    return "rgba(" .. stripped .. "ff)"
end
...
hl.config({
	...
	resize_on_border = true,
        ...
        col = {
            active_border   = { colors = { c(colors.primary), c(colors.primary) }, angle = 45 },
            inactive_border = c(colors.outline_variant),
        },
...
hl.bind(mainMod .. " + Space", hl.dsp.exec_cmd("bash " .. menu))
hl.bind(mainMod .. " + E",         hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + Q",         hl.dsp.window.close())
hl.bind(mainMod .. " + M", function()
    local code = os.execute("command -v hyprshutdown >/dev/null 2>&1")
    if code == 0 then
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/waybar/scripts/launch.sh"))
